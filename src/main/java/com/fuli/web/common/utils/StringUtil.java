...
public class StringUtil {
	 ...
	 * @return
	 */
	/*public static final String escapeJavaScript(String value) {
	...
	*//**
	 ...
	 * @return
	 *//*
	public static final String unescapeJavaScript(String value) {
		return org.apache.commons.lang.StringEscapeUtils
				.unescapeJavaScript(value);
	}*/
	...
	public static void main(String arg[]){
		...
		//--2
//		String tmp1 = escapeJavaScript("好人！");
//		System.out.println(tmp1);
//
//		tmp1 = unescapeJavaScript(tmp1);
//		System.out.println(tmp1);
		
		//--3
		try {		
			String tmp2 =URLEncoder.encode("好人！", "UTF-8");
		...
		//--4
		try {		
			String tmp3 =URLEncoder.encode("好人！", "ISO-8859-1");
