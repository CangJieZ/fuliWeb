 ...
 * @fileName com.chinagyl.common.util.DateTimeUtil.java
 * 
 */
public class DateTimeUtil {
	...
	/**
	 * @Auther: maomy  
	 * @Description: 格式化开始查询时间
	 * @Date:2014-12-25下午2:40:40
	 * @param datestring
	 * @return
	 * @throws ParseException  
	 * @return Date 
	 ...
	 */
	public static Date formatStartTime(String datestring) throws ParseException {
		String string = "";
		if ((datestring == null) || datestring.equals("")) {
			return null;
		}
		string = datestring + " 00:00:00";
		return getFormatDateTime(string);
	}
	...
	public static void main(String[] args) {
		/** ***********Test of convertTimeSpan***************** */
			...
			System.out
					.println(addDateEndfix(getFormatDate(getCurrDate())));
